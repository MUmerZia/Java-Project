...
public class InsertNewResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Electronics Engg.");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String electronic = jTextField5.getText();
        ...
        try
        {
         Class.forName("com.mysql.jdbc.Driver");    
           ...
           if (rs.next())
           {
            st.executeUpdate("insert into result (rollNo,phy,che,math,electronic,electrical) values(' "+rollNo+" ', ' "+phy+" ' , ' "+che+" ' , ' "+math+" ' , ' "+electronic+" ' , ' "+electrical+" ')");
           ...
           {
               JOptionPane.showMessageDialog(null,"Roll number doest not exist in our database");
             setVisible(false);
            new InsertNewResult().setVisible(true);
           }
        }
